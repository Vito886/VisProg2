class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("A + C = 1238 = MCCXXXVIII: " + RomanNumber.Add(a, c).ToString());
        Console.WriteLine("A - C = 2995 = MCCXXX: " + RomanNumber.Sub(a, c).ToString());
        Console.WriteLine("C * D = 400 = CD: " + RomanNumber.Mul(c, d).ToString());
        Console.WriteLine("D / C = 25 = XXV: " + RomanNumber.Div(d, c).ToString());
        Console.WriteLine("");
